...
const TABLE_COLUMNS: Record<string, string[]> = {
  ...
  patient_conditions: ['id', 'patient_id', 'user_id', 'condition_name', 'severity', 'diagnosed_date', 'notes', 'is_active', 'is_deleted', 'updated_by_device', 'deleted_by', 'deleted_at', 'version', 'created_at', 'updated_at'],
  emergency_contacts: ['id', 'legacy_id', 'patient_id', 'user_id', 'name', 'relation', 'relationship', 'phone', 'phone_number', 'email', 'priority', 'is_primary', 'is_deleted', 'updated_by_device', 'deleted_by', 'deleted_at', 'version', 'created_at', 'updated_at'],
  ...
  medications: ['id', 'patient_id', 'user_id', 'name', 'dosage', 'strength', 'category', 'reason', 'form', 'frequency', 'schedule_type', 'times', 'time_of_day', 'meal_rule', 'quantity_type', 'total_quantity', 'remaining_quantity', 'refill_threshold', 'duration_days', 'start_date', 'end_date', 'instructions', 'side_effects', 'notes', 'doctor_name', 'active', 'is_active', 'is_deleted', 'updated_by_device', 'deleted_by', 'version', 'deleted_at', 'created_at', 'updated_at'],
